...
const CoinDetail = () => {
    ...
    return (
        <div className='border border-2 border-gray-600 mx-1 my-2 p-2  md:mx-10 md:my-5 md:p-5'>
            ...
            <p className='mt-6 text-black text-xs text-justify md:text-lg font-serif  [&>a]:text-blue-600 [&>a]:underline' dangerouslySetInnerHTML={{ __html: response.description.en }}></p>
        </div>
    )
}
